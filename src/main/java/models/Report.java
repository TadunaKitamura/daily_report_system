...
//		@NamedQuery(name = JpaConst.Q_CON_GET_ALL, query = JpaConst.Q_CON_GET_ALL_DEF),


})
@NamedNativeQueries({
	@NamedNativeQuery(name = JpaConst.Q_CON_GET_ALL, query = JpaConst.Q_CON_GET_ALL_DEF, resultClass = Report.class),
